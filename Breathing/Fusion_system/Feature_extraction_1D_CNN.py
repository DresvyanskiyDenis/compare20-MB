...
from Breathing.Fusion_system.fusion_utils import transform_deep_features_to_filetype

def main(window_size=256000, data_parts=2, batch_size=32,
    ...
    step_sequence = window_size
    path_to_save_extracted_features = path_to_output_features
    path_to_model_for_part_0 = paths_to_models+'best_model_weights_idx_of_part_0.h5'
    path_to_model_for_part_1 = paths_to_models+'best_model_weights_idx_of_part_1.h5'
    path_to_model_for_part_2 = paths_to_models+'best_model_weights_idx_of_part_2.h5'
    path_to_model_for_part_3 = paths_to_models+'best_model_weights_idx_of_part_3.h5'
    ...
    for num_model in range(len(paths_to_models)):
        ...
        transformed_extracted_features_train = transform_deep_features_to_filetype(
            deep_features=extracted_features_train,
            timesteps_labels=prepared_train_labels_timesteps,
            class_dict=train_dict)
        transformed_extracted_features_development = transform_deep_features_to_filetype(
            deep_features=extracted_features_development,
